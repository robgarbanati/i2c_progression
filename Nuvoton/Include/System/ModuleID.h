...
typedef enum
{
	...
	MODULE_ID_DTMF				= 99,		// DTMF
	MODULE_ID_AUDIOCTRL			= 100,		// AudioCtrl
	MODULE_ID_TEMPODETECT		= 101,		// TempoDetect
	MODULE_ID_NUVOXDECODE		= 102,		// NuVoxDecode
	MODULE_ID_NUADCFILTER		= 103,		// NuADCFilter
	MODULE_ID_NUDACFILTER		= 104,		// NuDACFilter
	MODULE_ID_DIRDETECT			= 105,		// DirDetect
	MODULE_ID_EQ				= 106,		// Equalizer
	MODULE_ID_NULITECODEC		= 107,		// NuLiteCodec
	MODULE_ID_NULITEDECODE		= 108,		// NuLiteDecode
	MODULE_ID_NUONEDECODE		= 109,		// NuOneDecode
	MODULE_ID_OGGDEC			= 110,		// OggDecoder
	MODULE_ID_NUVOX53DECODE		= 111,		// NuVox53Decode
	MODULE_ID_MP3ENC			= 112,		// MP3Encoder
	MODULE_ID_SOFTAGC			= 113,		// SoftAGC
