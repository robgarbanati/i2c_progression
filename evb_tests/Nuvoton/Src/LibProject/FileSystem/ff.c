...
)
{
	...
	u8PartType = fs->win[MBR_Table_PartType];
	if ((LD_DWORD(&fs->win[BS_FilSysType]) & 0xFFFFFF) == 0x544146){	/* Check "FAT" string */
		if((u8PartType == 0x1) || (u8PartType == 0x4) || (u8PartType == 0x6) || (u8PartType == 0xB) || (u8PartType == 0xC) || (u8PartType == 0xE) || 
		   (u8PartType == 0x11) || (u8PartType == 0x14) || (u8PartType == 0x1B) || (u8PartType == 0x1C) || (u8PartType == 0x1D)) /* For linux mkdosfs */
			return 1;
		return 0;
	}
